        ...
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="email" class="form-control" id="email" placeholder="Enter email" name="donor_email"
                            required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="state" placeholder="State" name="donor_state"
                            required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="city" placeholder="City" name="donor_city" required>
                    </div>
                </div>
